...
<head>
    ...
    <title>Alerts+Kanalpunkte | Gallery</title>

    <meta name="description" content="onkelinfo - Bootstrap template for communities and games store">
    <meta name="keywords" content="game, gaming, template, HTML template, responsive, Bootstrap, premium">
    <meta name="author" content="onkelinfo">
        ...
        <div class="container">
            <div class="nk-nav-table">
                ...
                <a href="index.php" class="nk-nav-logo">
                   <!--    <img src="https://onkelinfo.de/includes/themes/slate/images/logo.png" alt="onkelinfo" width="199"> -->
                </a>
        ...
        <li class=" nk-drop-item">
            <a href="#">
                Home
			        ...
			        <li class=" nk-drop-item">
            <a href="https://onkelinfo.de/index.php?site=forum">
                Forum
            </a>
...
<div id="nk-nav-mobile" class="nk-navbar nk-navbar-side nk-navbar-right-side nk-navbar-overlay-content d-lg-none">
    <div class="nano">
        <div class="nano-content">
            <a href="index.php" class="nk-nav-logo">
              <!--  <img src="https://onkelinfo.de/includes/themes/slate/images/logo.png" alt="" width="120"> -->
            </a>
...
<div class="container">
    <ul class="nk-breadcrumbs">
        ...
        <li><span>Ich beantworte Frage im Videos</span></li>
...
<div class="container">
    <div class="row vertical-gap">
        <div class="col-lg-8">
            ...
            <div class="nk-gap-2"></div>
            <h2 class="nk-decorated-h-2 h3"><span><span class="text-main-1">Video</span> Ich beantworte DEINE Frage</span></h2>
            <div class="nk-gap"></div>
            <div class="row vertical-gap">
                <div class="col-md-6">
                    <h4>Ich beantworte DEINE Frage im Video Alerts + Kanalpunkte</h4>
<video controls loop muted height="220" width="390">
	<source src="/videoalerts/assets/video/AlertsKanalpunkte.mp4" type="video/mp4">
</video>
                </div>
                    </div>
            ...
            <div class="nk-gap-2"></div>
            <h2 class="nk-decorated-h-2 h3"><span><span class="text-main-1">Video</span> youtube</span></h2>
            <div class="nk-gap"></div>
            <div class="row vertical-gap">
                <div class="col-md-6">
                    <h4>Demo Survival WarVWorld for Project Games ( @onkelpaulplay )</h4>
                    <div class="nk-plain-video" data-video="https://www.youtube.com/watch?v=VNVRtjkKaXk"></div>
                </div>
                <div class="col-md-6">
                    <h4>Maggi´s Zockerbude // Hunt-Showdown // Twitch // Fight um Goddard und es wird meine beste 1 Runde</h4>
                    <div class="nk-plain-video" data-video="https://www.youtube.com/watch?v=FeL59ZavOsg"></div>
                </div>
               <div class="col-md-6">
                    <h4>
shorts .youtube| starstrik3r auf #Twitch </h4>
                    <div class="nk-plain-video" data-video="https://youtube.com/shorts/EIycBDBBCH0?si=jQ4K8C_ECfCOvE2S"></div>
                </div>
            </div>
            <!-- END: Video Galleries -->
...
<div class="nk-widget nk-widget-highlighted">
    ...
    <div class="nk-widget-content">
        ...
        <ul class="nk-social-links-3 nk-social-links-cols-3">
            ...
            <li>onkelpaulplay<a class="nk-social-twitch" href="https://www.twitch.tv/onkelpaulplay"><span class="fab fa-twitch"></span></a></li>
			
			<li>maggi2k<a class="nk-social-twitch" href="https://www.twitch.tv/maggi2k"><span class="fab fa-twitch"></span></a></li>
			
			<li>starstrik3r<a class="nk-social-twitch" href="https://www.twitch.tv/starstrik3r"><span class="fab fa-twitch"></span></a></li>
        </ul>
    </div>
	<ul class="nk-social-links-3 nk-social-links-cols-3">

					
			<li><a class="nk-social-youtube" href="https://www.youtube.com/@onkelpaulplay"><span class="fab fa-youtube"></span>@onkelpaulplay</a></li>
			
			<li><a class="nk-social-youtube" href="https://www.youtube.com/@MrMaggi2k"><span class="fab fa-youtube"></span>@MrMaggi2k</a></li>
			
			<li><a class="nk-social-youtube" href="https://www.youtube.com/@-StaRStrik3r-"><span class="fab fa-youtube"></span>@-StaRStrik3r-</a></li>
    ...
    <div class="nk-copyright">
        <div class="container">
            <div class="nk-copyright-left">
                <a target="_blank" href="https://onkelinfo.de/">onkelinfo.de Templates</a>
            </div>
